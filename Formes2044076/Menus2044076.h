...
int validerMenu1(int MIN, int MAX, int QUITTER); //: Fonction qui lit le choix de l’utilisateur et vérifie que le choix est bien parmi les
//choix offerts dans le menu, informations passées en paramètre.Cette fonction
//retourne le choix validé.L’utilisateur peut taper n’importe quoi au clavier, le programme ne part pas en boucle infinie.
