...
// Maudifier par : Guillaume Lafrance
// Date :      6 Octobre 2020
...
#include "Menus2044076.h"		// Bibliothèque du programmeur rassemblant les fonctions permettant la gestion des menus et la validation des choix fait dans ces menus
#include "Formes2044076.h"		// Bibliothèque du programmeur offrant des fonctions permettant de dessiner différentes formes, pleines ou vides
...
int main()
{
	...
	afficherMenu1();
	choixForme = validerMenu1(1, 4, QUITTER);
	system("CLS");
	...
	while (choixForme != QUITTER)
	{
		...
		choixRemplissage = validerMenu2(1, 2, RETOUR);
